...
if os.path.exists(config_path): 
    ...
    hp_dict.update(chyperparameters)
hp_dict['root_path'] = '/opt/ml/input/data/training/'    
    
args = SimpleNamespace(**hp_dict)    
...
def copytree(src, dst, symlinks=False, ignore=None):
    for item in os.listdir(src):
        ...
        if os.path.isdir(s):
            ...
            shutil.copy2(s, d)
model_local_path = "./results"            
model_sagemaker_path = "/opt/ml/model/"            
copytree(model_local_path, model_sagemaker_path,symlinks=False, ignore=None)            
